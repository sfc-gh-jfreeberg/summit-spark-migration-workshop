...
**Reason (from Snowpark documentation):** N if from string to datetime/timedelta or errors == "ignore"
...
The SMA adds the EWI `PNDSPY1038` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
