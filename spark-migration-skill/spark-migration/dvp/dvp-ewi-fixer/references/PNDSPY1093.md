...
**Reason (from Snowpark documentation):** N if decimals is Series
...
The SMA adds the EWI `PNDSPY1093` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
