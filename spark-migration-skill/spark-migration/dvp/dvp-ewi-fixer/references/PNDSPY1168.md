...
**Reason (from Snowpark documentation):** N if index, columns, or values is not str; or MultiIndex; or any aggfunc is not a supported aggregation function <agg_supp.html>_
...
The SMA adds the EWI `PNDSPY1168` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
