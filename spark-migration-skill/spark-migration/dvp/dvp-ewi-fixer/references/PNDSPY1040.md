...
**Reason (from Snowpark documentation):** N if param downcast is set.
...
The SMA adds the EWI `PNDSPY1040` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
