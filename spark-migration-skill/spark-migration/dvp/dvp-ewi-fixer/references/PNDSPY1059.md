...
**Reason (from Snowpark documentation):** N for MultiIndex dataframes
...
The SMA adds the EWI `PNDSPY1059` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
