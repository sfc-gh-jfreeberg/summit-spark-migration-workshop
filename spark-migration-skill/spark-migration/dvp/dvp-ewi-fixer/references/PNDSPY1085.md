...
**Reason (from Snowpark documentation):** N if axis is MultiIndex or method is nearest.
...
The SMA adds the EWI `PNDSPY1085` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
