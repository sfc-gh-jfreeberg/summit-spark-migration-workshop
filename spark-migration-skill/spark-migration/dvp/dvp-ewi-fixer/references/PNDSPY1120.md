...
**Reason (from Snowpark documentation):** See idxmax
...
The SMA adds the EWI `PNDSPY1120` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
