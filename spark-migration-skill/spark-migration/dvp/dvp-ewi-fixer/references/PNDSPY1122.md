...
**Reason (from Snowpark documentation):** N if bins is given for SeriesGroupBy
...
The SMA adds the EWI `PNDSPY1122` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
