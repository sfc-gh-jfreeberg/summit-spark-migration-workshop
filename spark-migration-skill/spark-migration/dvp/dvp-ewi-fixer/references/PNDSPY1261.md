...
**Reason (from Snowpark documentation):** Supported parameter(s) are: columns
...
The SMA adds the EWI `PNDSPY1261` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
