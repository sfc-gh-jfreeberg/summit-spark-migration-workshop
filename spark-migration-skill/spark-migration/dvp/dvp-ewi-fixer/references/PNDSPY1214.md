...
**Reason (from Snowpark documentation):** N for non-integer level.
...
The SMA adds the EWI `PNDSPY1214` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
