...
**Reason (from Snowpark documentation):** N if df.columns is a MultiIndex
...
The SMA adds the EWI `PNDSPY1163` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
