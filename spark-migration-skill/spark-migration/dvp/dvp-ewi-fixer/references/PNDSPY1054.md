...
**Reason (from Snowpark documentation):** N if parameter data is set to a DataFrame
...
The SMA adds the EWI `PNDSPY1054` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
