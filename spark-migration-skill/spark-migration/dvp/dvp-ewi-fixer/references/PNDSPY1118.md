...
**Reason (from Snowpark documentation):** GroupBy axis = 0 is supported. Does not support downcast parameter
...
The SMA adds the EWI `PNDSPY1118` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
