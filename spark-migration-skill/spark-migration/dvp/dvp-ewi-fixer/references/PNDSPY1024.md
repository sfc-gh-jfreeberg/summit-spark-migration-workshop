...
**Reason (from Snowpark documentation):** N if locale is set.
...
The SMA adds the EWI `PNDSPY1024` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
