...
**Reason (from Snowpark documentation):** See T
...
The SMA adds the EWI `PNDSPY1108` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
