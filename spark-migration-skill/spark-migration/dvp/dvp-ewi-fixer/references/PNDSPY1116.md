...
**Reason (from Snowpark documentation):** Check Supported Aggregation Functions <agg_supp.html>_ for a list of supported functions.
...
The SMA adds the EWI `PNDSPY1116` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
