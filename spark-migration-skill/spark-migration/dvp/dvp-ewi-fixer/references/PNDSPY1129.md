...
**Reason (from Snowpark documentation):** Does not support min_count parameter
...
The SMA adds the EWI `PNDSPY1129` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
