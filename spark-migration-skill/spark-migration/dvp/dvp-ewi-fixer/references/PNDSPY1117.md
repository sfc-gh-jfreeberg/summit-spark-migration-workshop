...
**Reason (from Snowpark documentation):** See agg
...
The SMA adds the EWI `PNDSPY1117` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
