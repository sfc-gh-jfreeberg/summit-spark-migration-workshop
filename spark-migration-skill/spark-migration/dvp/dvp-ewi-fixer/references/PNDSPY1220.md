...
**Reason (from Snowpark documentation):** Does not check for special digits, like superscripted and subscripted digits in unicode
...
The SMA adds the EWI `PNDSPY1220` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
