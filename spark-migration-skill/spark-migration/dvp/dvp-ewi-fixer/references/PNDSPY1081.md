...
**Reason (from Snowpark documentation):** Y if axis == 0, and interpolation is "linear" or "nearest", and method is "single".
...
The SMA adds the EWI `PNDSPY1081` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
