...
**Reason (from Snowpark documentation):** Snowpark pandas currently uses stable sort when sorting the index values. Pandas uses quicksort.
...
The SMA adds the EWI `PNDSPY1142` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
