...
**Reason (from Snowpark documentation):** N if mapper is callable or the series has MultiIndex
...
The SMA adds the EWI `PNDSPY1200` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
