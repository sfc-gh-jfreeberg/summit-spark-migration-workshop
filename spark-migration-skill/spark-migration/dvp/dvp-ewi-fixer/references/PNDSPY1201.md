...
**Reason (from Snowpark documentation):** See floordiv
...
The SMA adds the EWI `PNDSPY1201` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
