...
**Reason (from Snowpark documentation):** N if any value in table has multiple characters.
...
The SMA adds the EWI `PNDSPY1229` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
