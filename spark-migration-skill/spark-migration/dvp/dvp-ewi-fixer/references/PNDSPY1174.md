...
**Reason (from Snowpark documentation):** N if condition or replacement is a callable.
...
The SMA adds the EWI `PNDSPY1174` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
