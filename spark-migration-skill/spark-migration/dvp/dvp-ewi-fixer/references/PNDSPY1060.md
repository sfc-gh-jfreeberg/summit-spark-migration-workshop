...
**Reason (from Snowpark documentation):** Index is different, zero bytes reported for memory
...
The SMA adds the EWI `PNDSPY1060` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
