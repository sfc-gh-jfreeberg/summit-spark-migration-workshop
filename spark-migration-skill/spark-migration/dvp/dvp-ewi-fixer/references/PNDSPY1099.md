...
**Reason (from Snowpark documentation):** N if axis == 1 or skipna == False or numeric_only=False
...
The SMA adds the EWI `PNDSPY1099` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
