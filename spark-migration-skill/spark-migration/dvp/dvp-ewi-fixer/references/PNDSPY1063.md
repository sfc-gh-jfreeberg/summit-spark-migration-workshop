...
**Reason (from Snowpark documentation):** N for set with MultiIndex.
...
The SMA adds the EWI `PNDSPY1063` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
