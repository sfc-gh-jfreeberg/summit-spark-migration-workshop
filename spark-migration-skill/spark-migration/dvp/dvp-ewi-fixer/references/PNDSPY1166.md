...
**Reason (from Snowpark documentation):** N if aggfunc is not a supported aggregation function <agg_supp.html>_, margins is True, normalize is "all" or True, and values is passed.
...
The SMA adds the EWI `PNDSPY1166` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
