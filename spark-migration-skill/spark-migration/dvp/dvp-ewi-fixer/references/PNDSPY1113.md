...
**Reason (from Snowpark documentation):** See std
...
The SMA adds the EWI `PNDSPY1113` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
