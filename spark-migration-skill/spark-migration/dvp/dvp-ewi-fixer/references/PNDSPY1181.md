...
**Reason (from Snowpark documentation):** flags can only be read, and not set.
...
The SMA adds the EWI `PNDSPY1181` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
