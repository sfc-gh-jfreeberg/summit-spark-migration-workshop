...
**Reason (from Snowpark documentation):** N for non-integer window, axis = 1, pairwise = True, other = None, or min_periods != window
...
The SMA adds the EWI `PNDSPY1247` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
