...
**Reason (from Snowpark documentation):** See mask
...
The SMA adds the EWI `PNDSPY1114` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
