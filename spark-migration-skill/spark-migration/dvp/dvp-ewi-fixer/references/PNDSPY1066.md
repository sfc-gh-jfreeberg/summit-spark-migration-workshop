...
**Reason (from Snowpark documentation):** N if given axis when other is a DataFrame or level parameters; N if cond or other is Callable
...
The SMA adds the EWI `PNDSPY1066` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
