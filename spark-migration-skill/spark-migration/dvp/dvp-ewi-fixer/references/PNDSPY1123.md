...
**Reason (from Snowpark documentation):** Implemented for DataFrameGroupBy objects only
...
The SMA adds the EWI `PNDSPY1123` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
