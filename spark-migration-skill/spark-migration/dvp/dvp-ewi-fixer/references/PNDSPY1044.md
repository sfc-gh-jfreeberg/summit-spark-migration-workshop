...
**Reason (from Snowpark documentation):** Y if values are numeric
...
The SMA adds the EWI `PNDSPY1044` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
