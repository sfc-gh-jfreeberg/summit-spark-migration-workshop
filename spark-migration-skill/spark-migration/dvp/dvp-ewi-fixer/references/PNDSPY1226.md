...
**Reason (from Snowpark documentation):** N if pat is non-string, n is non-numeric, or regex is set.
...
The SMA adds the EWI `PNDSPY1226` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
