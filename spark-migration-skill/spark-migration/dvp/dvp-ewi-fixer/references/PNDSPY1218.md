...
**Reason (from Snowpark documentation):** N if the na parameter is set to a non-bool value.
...
The SMA adds the EWI `PNDSPY1218` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
