...
**Reason (from Snowpark documentation):** N if the series has MultiIndex, or method is nearest.
...
The SMA adds the EWI `PNDSPY1199` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
