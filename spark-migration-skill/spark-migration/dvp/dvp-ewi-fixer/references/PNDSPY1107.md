...
**Reason (from Snowpark documentation):** Y if func is callable.
...
The SMA adds the EWI `PNDSPY1107` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
