"""SCOS test for 04_functional_pipeline.ipynb entrypoint."""
import importlib
...
class Test04FunctionalPipeline(BaseScosWorkloadTest):
    """Test suite for the 04_functional_pipeline.ipynb SCOS migrated workload."""
    ...
    def _call_main(self, session):
        ...
        migrated_file=migrated_dir/"04_functional_pipeline.ipynb.py"
        spec=importlib.util.spec_from_file_location("04_functional_pipeline_ipynb_py",migrated_file)
