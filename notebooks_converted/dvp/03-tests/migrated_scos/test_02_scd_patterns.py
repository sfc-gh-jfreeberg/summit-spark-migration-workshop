"""SCOS test for 02_scd_patterns.ipynb entrypoint."""
import importlib
...
class Test02ScdPatterns(BaseScosWorkloadTest):
    """Test suite for the 02_scd_patterns.ipynb SCOS migrated workload."""

    INPUT_FILES = [
        {
            "name": "df:source_df",
            "full_name": "df:source_df",
            "source": "02_scd_patterns.ipynb.py:0",
            "type": "file",
            "format": "memory",
            "detection": "static",
            "role": "input",
        ...
        {
            "name": "df:valuations_df",
            "full_name": "df:valuations_df",
            "source": "02_scd_patterns.ipynb.py:0",
            "type": "file",
            "format": "memory",
            "detection": "static",
    ...
    def _call_main(self, session):
        ...
        migrated_file=migrated_dir/"02_scd_patterns.ipynb.py"
        spec=importlib.util.spec_from_file_location("02_scd_patterns_ipynb_py",migrated_file)
