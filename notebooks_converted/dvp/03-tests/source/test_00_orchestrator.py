"""Source test for 00_orchestrator.ipynb entrypoint."""
import importlib
...
class Test00Orchestrator(BaseSourceWorkloadTest):
    """Test suite for the 00_orchestrator.ipynb source workload."""
    ...
    def _call_main(self, session):
        ...
        source_file=source_dir/"00_orchestrator.ipynb.py"
        spec=importlib.util.spec_from_file_location("00_orchestrator_ipynb_py",source_file)
