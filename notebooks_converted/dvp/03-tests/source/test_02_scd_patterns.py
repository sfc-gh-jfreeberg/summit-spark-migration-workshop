"""Source test for 02_scd_patterns.ipynb entrypoint."""
import importlib
...
class Test02ScdPatterns(BaseSourceWorkloadTest):
    """Test suite for the 02_scd_patterns.ipynb source workload."""
    ...
    def _call_main(self, session):
        ...
        source_file=source_dir/"02_scd_patterns.ipynb.py"
        spec=importlib.util.spec_from_file_location("02_scd_patterns_ipynb_py",source_file)
