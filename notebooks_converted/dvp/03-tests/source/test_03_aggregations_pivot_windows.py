"""Source test for 03_aggregations_pivot_windows.ipynb entrypoint."""
import importlib
...
class Test03AggregationsPivotWindows(BaseSourceWorkloadTest):
    """Test suite for the 03_aggregations_pivot_windows.ipynb source workload."""
    ...
    def _call_main(self, session):
        ...
        source_file=source_dir/"03_aggregations_pivot_windows.ipynb.py"
        spec=importlib.util.spec_from_file_location("03_aggregations_pivot_windows_ipynb_py",source_file)
