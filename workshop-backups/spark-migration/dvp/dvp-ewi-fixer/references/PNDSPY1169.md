...
**Reason (from Snowpark documentation):** N if retbins=Trueor labels!=False
...
The SMA adds the EWI `PNDSPY1169` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
