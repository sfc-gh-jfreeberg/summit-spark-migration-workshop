...
**Reason (from Snowpark documentation):** N if error == "ignore"
...
The SMA adds the EWI `PNDSPY1231` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
