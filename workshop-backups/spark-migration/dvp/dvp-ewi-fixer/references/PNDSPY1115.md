...
**Reason (from Snowpark documentation):** No support for freq != None
...
The SMA adds the EWI `PNDSPY1115` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
