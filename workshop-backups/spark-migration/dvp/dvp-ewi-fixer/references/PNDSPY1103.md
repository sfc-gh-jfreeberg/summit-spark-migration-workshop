...
**Reason (from Snowpark documentation):** N if ddof is not 0 or 1
...
The SMA adds the EWI `PNDSPY1103` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
