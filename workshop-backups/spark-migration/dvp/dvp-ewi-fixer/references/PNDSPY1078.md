...
**Reason (from Snowpark documentation):** See pivot_table
...
The SMA adds the EWI `PNDSPY1078` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
