...
**Reason (from Snowpark documentation):** Y if axis = 0, freq is None, and limit is None
...
The SMA adds the EWI `PNDSPY1131` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
