...
**Reason (from Snowpark documentation):** Y if values are numeric, and interpolation is "linear" or "nearest"; N if q is a DataFrame or Series
...
The SMA adds the EWI `PNDSPY1196` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
