...
**Reason (from Snowpark documentation):** No support for dataframes with a row MultiIndex.
...
The SMA adds the EWI `PNDSPY1049` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
