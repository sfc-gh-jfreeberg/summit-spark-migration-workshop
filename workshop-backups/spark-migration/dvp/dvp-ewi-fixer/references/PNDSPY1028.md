...
**Reason (from Snowpark documentation):** N if the Series has a MultiIndex index.
...
The SMA adds the EWI `PNDSPY1028` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
