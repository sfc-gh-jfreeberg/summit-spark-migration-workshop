...
**Reason (from Snowpark documentation):** N if axis == 1
...
The SMA adds the EWI `PNDSPY1047` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
