...
**Reason (from Snowpark documentation):** N if keep == "all"
...
The SMA adds the EWI `PNDSPY1074` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
