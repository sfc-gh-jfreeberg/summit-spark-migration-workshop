...
**Reason (from Snowpark documentation):** N if date_format contains directives other than (%d, %m, %Y, %H, %M, %S, %f, %j, %X, %%).
...
The SMA adds the EWI `PNDSPY1019` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
