...
**Reason (from Snowpark documentation):** N if to_strip is non-string.
...
The SMA adds the EWI `PNDSPY1228` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
