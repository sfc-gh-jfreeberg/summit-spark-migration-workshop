...
**Reason (from Snowpark documentation):** When GroupBy axis is 1,N; GroupBy axis = 0 is fully supported.
...
The SMA adds the EWI `PNDSPY1127` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
