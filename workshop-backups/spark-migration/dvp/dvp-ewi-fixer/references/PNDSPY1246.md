...
**Reason (from Snowpark documentation):** N for axis = 1 or min_periods = 0. N for string window with center = True. N for Timedelta or BaseIndexer window.
...
The SMA adds the EWI `PNDSPY1246` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
