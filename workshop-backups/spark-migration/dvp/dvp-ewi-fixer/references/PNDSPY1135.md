...
**Reason (from Snowpark documentation):** Y if axis = 0, freq is None, level is None, and by is in the columns
...
The SMA adds the EWI `PNDSPY1135` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
