...
**Reason (from Snowpark documentation):** N if errors is given or converting from string type
...
The SMA adds the EWI `PNDSPY1232` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
