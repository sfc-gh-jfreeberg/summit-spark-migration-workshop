...
**Reason (from Snowpark documentation):** Y if values are numeric, otherwise fails.
...
The SMA adds the EWI `PNDSPY1176` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
