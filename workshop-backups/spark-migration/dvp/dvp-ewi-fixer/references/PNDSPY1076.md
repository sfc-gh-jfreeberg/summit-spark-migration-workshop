...
**Reason (from Snowpark documentation):** See ffill
...
The SMA adds the EWI `PNDSPY1076` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
