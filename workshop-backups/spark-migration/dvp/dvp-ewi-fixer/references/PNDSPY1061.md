...
**Reason (from Snowpark documentation):** N if given the validate param.
...
The SMA adds the EWI `PNDSPY1061` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
