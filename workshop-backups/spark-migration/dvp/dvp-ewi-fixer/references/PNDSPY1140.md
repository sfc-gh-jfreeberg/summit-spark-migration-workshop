...
**Reason (from Snowpark documentation):** Only single Index supported.
...
The SMA adds the EWI `PNDSPY1140` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
