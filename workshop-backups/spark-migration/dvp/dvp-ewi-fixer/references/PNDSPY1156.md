...
**Reason (from Snowpark documentation):** Method nearest is not supported.
...
The SMA adds the EWI `PNDSPY1156` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
