...
**Reason (from Snowpark documentation):** See truediv
...
The SMA adds the EWI `PNDSPY1206` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
