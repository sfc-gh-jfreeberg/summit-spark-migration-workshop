...
**Reason (from Snowpark documentation):** N for MultiIndex
...
The SMA adds the EWI `PNDSPY1102` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
