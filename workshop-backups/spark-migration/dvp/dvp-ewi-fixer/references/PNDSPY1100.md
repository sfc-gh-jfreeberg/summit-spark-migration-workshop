...
**Reason (from Snowpark documentation):** N if given the key param. N if axis == 1, or MultiIndex.
...
The SMA adds the EWI `PNDSPY1100` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
