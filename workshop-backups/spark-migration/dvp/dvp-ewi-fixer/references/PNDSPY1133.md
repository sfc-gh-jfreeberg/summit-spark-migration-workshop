...
**Reason (from Snowpark documentation):** Implemented for DataFrameGroupBy objects. Only DatetimeIndex is supported and its freq will be lost. rule frequencies 's', 'min', 'h', and 'D' are supported.
...
The SMA adds the EWI `PNDSPY1133` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
