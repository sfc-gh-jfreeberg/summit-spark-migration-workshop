...
**Reason (from Snowpark documentation):** N if param direction is nearest
...
The SMA adds the EWI `PNDSPY1165` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
