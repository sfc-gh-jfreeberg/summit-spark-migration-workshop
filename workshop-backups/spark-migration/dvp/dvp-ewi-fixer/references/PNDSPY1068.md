...
**Reason (from Snowpark documentation):** N if param validate is given
...
The SMA adds the EWI `PNDSPY1068` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
