...
**Reason (from Snowpark documentation):** N if labels!=False or retbins=True.
...
The SMA adds the EWI `PNDSPY1170` on the output code to let you know that this element has a few scenarios not supported in Snowpark.
