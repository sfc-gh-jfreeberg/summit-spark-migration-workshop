"""SCOS test for 03_aggregations_pivot_windows.ipynb entrypoint."""
import importlib
...
class Test03AggregationsPivotWindows(BaseScosWorkloadTest):
    """Test suite for the 03_aggregations_pivot_windows.ipynb SCOS migrated workload."""
    ...
    def _call_main(self, session):
        ...
        migrated_file=migrated_dir/"03_aggregations_pivot_windows.ipynb.py"
        spec=importlib.util.spec_from_file_location("03_aggregations_pivot_windows_ipynb_py",migrated_file)
