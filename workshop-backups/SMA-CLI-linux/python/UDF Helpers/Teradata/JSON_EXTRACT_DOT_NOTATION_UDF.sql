-- <copyright file="JSON_EXTRACT_DOT_NOTATION_UDF.sql" company="Snowflake Inc">
--        Copyright (c) 2019-2025 Snowflake Inc. All rights reserved.
-- </copyright>

-- ======================================================================
-- DESCRIPTION: UDF that reproduces dot notation used to quering of values inside json objects
-- PARAMETERS:
...
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.JSON_EXTRACT_DOT_NOTATION_UDF(JSON_OBJECT VARIANT, JSON_PATH STRING)
RETURNS VARIANT
LANGUAGE JAVASCRIPT
IMMUTABLE
...
if (result.length == 1 || /^\$\.\w[\.\w]*$/.test(JSON_PATH)){
    result = result[0];
